...
class OperatorRIDNotification(models.Model):
    ...
    session_id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, blank=True, null=True)
    ...
    flight_declaration = models.ForeignKey(FlightDeclaration, blank=True, null=True)
