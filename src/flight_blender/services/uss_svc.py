...
def uss_operational_intent_details(opint_id: str) -> tuple[dict, int]:
...
def uss_update_opint_details(request_data: dict) -> tuple[dict, int]:
...
def uss_constraint_details(constraint_id: str) -> tuple[dict, int]:
    my_database_reader = SyncDatabaseFacade()
...
def uss_update_constraint_details(request_data: dict) -> int:
    my_database_reader = SyncDatabaseFacade()
...
def get_uss_flights(view: str) -> tuple[dict, int]:
    try:
...
def get_uss_flight_details(flight_id: str) -> tuple[dict, int]:
    my_database_reader = SyncDatabaseFacade()
