...
class ConformanceRepository(Protocol):
    ...
    async def get_conformance_record_by_flight_declaration(self, flight_declaration: Any) -> Any | None: ...
    async def get_conformance_monitoring_task(self, flight_declaration: Any) -> Any | None: ...
    async def write_flight_conformance_record(
        self,
    ...
    async def create_conformance_monitoring_periodic_task(self, flight_declaration: Any) -> bool: ...
    async def remove_conformance_monitoring_periodic_task(self, conformance_monitoring_task: Any) -> None: ...
