# Use this file to write your custom volume generation class and then update the environment variable to flight_blender.flight_declarations.custom_utils.CustomVolumeGenerator
