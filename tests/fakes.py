...
def fake_submission_conflict():
    ...
    from flight_blender.core.entities.scd import OtherError, OperationalIntentSubmissionStatus
...
def fake_delete_failure():
    ...
    from flight_blender.core.entities.scd import CommonDSS4xxResponse, DeleteOperationalIntentResponse
