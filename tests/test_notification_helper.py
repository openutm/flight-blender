"""Tests for notification_operations/notification_helper.py.
...
from notification_operations.data_definitions import FlightDeclarationUpdateMessage, NotificationLevel
...
def mock_pika():
    ...
    with patch("notification_operations.notification_helper.pika.BlockingConnection", return_value=mock_conn) as p:
