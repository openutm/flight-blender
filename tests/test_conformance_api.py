...
class TestConformanceStatus:
    def test_conformance_status(self, mounted_sync_client):
    ...
    def test_conformance_status_unauthenticated(self, mounted_sync_client):
        resp = mounted_sync_client.get("/conformance_monitoring_ops/conformance_status")
        assert resp.status_code == 401


@pytest.mark.django_db
class TestConformanceRecords:
    def test_get_conformance_records_missing_params(self, mounted_sync_client):
        resp = mounted_sync_client.get(
    ...
    def test_get_conformance_records_missing_end_date(self, mounted_sync_client):
        resp = mounted_sync_client.get(
    ...
    def test_get_conformance_records_invalid_date_format(self, mounted_sync_client):
        resp = mounted_sync_client.get(
    ...
    def test_get_conformance_records_start_after_end(self, mounted_sync_client):
        resp = mounted_sync_client.get(
            "/conformance_monitoring_ops/get_conformance_records"
    ...
    def test_get_conformance_records_valid_returns_empty_list(self, mounted_sync_client):
        resp = mounted_sync_client.get(
            "/conformance_monitoring_ops/get_conformance_records"
...
class TestConformanceRecordSummary:
    def test_conformance_record_summary_missing_params(self, mounted_sync_client):
        resp = mounted_sync_client.get(
    ...
    def test_conformance_record_summary_invalid_date_format(self, mounted_sync_client):
        resp = mounted_sync_client.get(
    ...
    def test_conformance_record_summary_start_after_end(self, mounted_sync_client):
        resp = mounted_sync_client.get(
            "/conformance_monitoring_ops/conformance_record_summary"
            "?start_date=2025-12-31T00:00:00Z&end_date=2025-01-01T00:00:00Z",
            headers=fastapi_auth_header(READ_SCOPE),
    ...
    def test_conformance_record_summary_valid_empty_db(self, mounted_sync_client):
        resp = mounted_sync_client.get(
            "/conformance_monitoring_ops/conformance_record_summary"
            "?start_date=2025-01-01T00:00:00Z&end_date=2025-12-31T23:59:59Z",
            headers=fastapi_auth_header(READ_SCOPE),
    ...
    def test_get_conformance_record_summary_alias_route(self, mounted_sync_client):
        resp = mounted_sync_client.get(
