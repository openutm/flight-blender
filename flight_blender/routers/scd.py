...
async def upsert_flight_plan(
    ...
    return FlightPlanResponse(flight_plan_id=flight_plan_id, planning_result="Planned", notes="Accepted")
...
async def clear_area(payload: ClearAreaRequest):
    return ClearAreaResponse(outcome={"success": True, "message": "Area cleared"})
...
async def upsert_uspace_flight_plan(
    ...
    return FlightPlanResponse(flight_plan_id=flight_plan_id, planning_result="Planned", notes="U-Space accepted")
...
async def clear_uspace_area(payload: ClearAreaRequest):
    return ClearAreaResponse(outcome={"success": True, "message": "U-Space area cleared"})
