...
class FlightBlenderDatabaseWriter:
    ...
    def create_flight_declaration(self, flight_declaration_creation: FlightDeclarationCreationPayload) -> Union[None, FlightDeclaration]:
        try:
