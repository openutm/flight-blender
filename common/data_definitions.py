...
DEFAULT_UAV_CLIMB_RATE_M_PER_S = env.get("DEFAULT_UAV_CLIMB_RATE_M_PER_S", 2)  # ~7.2 km/h
DEFAULT_UAV_DESCENT_RATE_M_PER_S = env.get("DEFAULT_UAV_DESCENT_RATE_M_PER_S", 2)  # ~7.2 km/h